...
- `Directory.Build.props` / `Directory.Packages.props` for centralized build and package version management.
...
- Fixed sync-over-async deadlock risk in `SettingAccessor.Get()`.
